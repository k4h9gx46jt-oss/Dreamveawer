...
#ifndef DREAMWEAVER_SWIFT_H
#define DREAMWEAVER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DreamWeaver",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC11DreamWeaver29PhoneWatchConnectivityManager")
@interface PhoneWatchConnectivityManager : NSObject
...
@class WCSession;
@class NSString;
@interface PhoneWatchConnectivityManager (SWIFT_EXTENSION(DreamWeaver)) <WCSessionDelegate>
