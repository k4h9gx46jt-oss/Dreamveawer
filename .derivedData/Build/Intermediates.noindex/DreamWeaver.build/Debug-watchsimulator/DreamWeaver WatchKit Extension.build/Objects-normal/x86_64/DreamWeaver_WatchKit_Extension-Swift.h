...
#ifndef DREAMWEAVER_WATCHKIT_EXTENSION_SWIFT_H
#define DREAMWEAVER_WATCHKIT_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DreamWeaver_WatchKit_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC30DreamWeaver_WatchKit_Extension17ExtensionDelegate")
...
SWIFT_CLASS("_TtC30DreamWeaver_WatchKit_Extension28WatchSideConnectivityManager")
@interface WatchSideConnectivityManager : NSObject
...
@interface WatchSideConnectivityManager (SWIFT_EXTENSION(DreamWeaver_WatchKit_Extension)) <WCSessionDelegate>
...
SWIFT_CLASS("_TtC30DreamWeaver_WatchKit_Extension14WorkoutManager")
...
@class HKSampleType;
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaver_WatchKit_Extension)) <HKLiveWorkoutBuilderDelegate>
...
@class NSDate;
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaver_WatchKit_Extension)) <HKWorkoutSessionDelegate>
...
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaver_WatchKit_Extension)) <WKExtendedRuntimeSessionDelegate>
